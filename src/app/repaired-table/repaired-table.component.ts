...
@Component({
  selector: 'app-repaired-table',
  templateUrl: './repaired-table.component.html',
  styleUrls: ['./repaired-table.component.scss']
})

export class RepairedTableComponent implements OnInit {
